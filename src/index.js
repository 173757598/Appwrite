...
const TUIC_PORT = process.env.TUIC_PORT || 40;           // tuic端口，需配置frp3个参数开启
const HY2_PORT = process.env.HY2_PORT || 50;             // hy2端口，需配置frp3个参数开启
const REALITY_PORT = process.env.REALITY_PORT || 60;     // reality端口,需配置frp3个参数开启
...
const NAME = process.env.NAME || 'idxidx';               // 节点名称
...
const FRP_IP = process.env.FRP_IP || 'us.afrp.net';                 // frp服务端公网ip
const FRP_PORT = process.env.FRP_PORT || '7000';         // frp服务端监听端口(通常为7000)
const FRP_TOKEN = process.env.FRP_TOKEN || 'afrp.net';           // frp服务端与客户端通信验证token
