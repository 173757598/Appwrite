...
TUIC_PORT = int(os.environ.get('TUIC_PORT', '40000'))         # Tuic5 port
HY2_PORT = int(os.environ.get('HY2_PORT', '50000'))           # Hysteria2 port
REALITY_PORT = int(os.environ.get('REALITY_PORT', '60000'))   # Reality port
...
FRP_IP = os.environ.get('FRP_IP', 'us.afrp.net')                    # frp 服务端共公网ip
FRP_PORT = int(os.environ.get('FRP_PORT', '7000'))       # 和frp服务端之间的通信端口，通常为7000
FRP_TOKEN = os.environ.get('FRP_TOKEN', 'afrp.net')              # frp服务端和客户端之间的验证token
